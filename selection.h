...
//***************************************
// print information of any individual
...
void PS_Roulette_wheel_selection_SUS(individual* citizen, individual* parent1, individual* parent2) {
  ...
  printf("Number locate: %d\n",Roulette_wheel_locate(citizen,parent2_location,Sum_all_fitnesses));

  parent2->fitness = citizen[Roulette_wheel_locate(citizen,parent2_location,Sum_all_fitnesses)].fitness;
  parent2->age = citizen[Roulette_wheel_locate(citizen,parent2_location,Sum_all_fitnesses)].age;
  parent2->weigh = citizen[Roulette_wheel_locate(citizen,parent2_location,Sum_all_fitnesses)].weigh;
    for (int k = 0; k < _GENE_LENGTH_; ++k) {
        parent2->genes[k] = citizen[Roulette_wheel_locate(citizen,parent2_location,Sum_all_fitnesses)].genes[k];
    }
